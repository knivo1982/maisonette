        ...
        {loading ? (
          ...
          <>
            ...
            {activeTab === 'units' && (
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <h2 className="font-cinzel text-xl">Casette</h2>
                    ...
                    <DialogContent>
                      ...
                      <form onSubmit={handleUnitSubmit} className="space-y-4">
                        ...
                        <div>
                          ...
                          <Input
                            value={unitForm.immagine_url}
                            onChange={(e) => setUnitForm({ ...unitForm, immagine_url: e.target.value })}
                            placeholder="https://..."
                          />
                        </div>
                        <div className="flex items-center gap-2">
