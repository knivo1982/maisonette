  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
        ...
        {/* Map Choice Dialog */}
        {showMapChoice && (
          <div className="fixed inset-0 bg-black/50 z-50 flex items-end justify-center p-4" onClick={() => setShowMapChoice(false)}>
            <div className="bg-white rounded-2xl w-full max-w-md p-6 mb-4" onClick={e => e.stopPropagation()}>
              ...
              <div className="space-y-3">
                <button
                  onClick={() => { openAppleMaps(selectedEvent, mapAction); setShowMapChoice(false); }}
                ...
                <button
                  onClick={() => { openGoogleMaps(selectedEvent, mapAction); setShowMapChoice(false); }}
                  className="w-full flex items-center gap-4 p-4 bg-gray-50 hover:bg-gray-100 rounded-xl transition-colors"
                >
